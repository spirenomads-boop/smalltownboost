#!/usr/bin/env python3
"""
Generate product sales website with media gallery and video
Jimny M65 Supercharger Kit
"""
...
def generate_product_html():
    """Generate HTML for product sales page with media"""
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div style="margin-top: 30px;">
                ...
                <button class="cta-button cta-secondary" onclick="document.getElementById('video').scrollIntoView({behavior: 'smooth'})">Watch Video</button>
            </div>
        </div>
    </section>
    ...
    <section id="video" class="video-section">
        <div class="video-container">
            <h2 style="margin-bottom: 30px;">Why I Built This</h2>
            <div class="video-wrapper">
                <video controls poster="657388042_1639675567073408_8093226719779578230_n.jpg">
                    <source src="underthehood - intro.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            </div>
            <div class="video-text">
                <h3>Straight from Travis</h3>
                <p>Watch how this supercharger setup completely changed the Jimny's performance and why I'm offering the bracket kit to others.</p>
            </div>
        </div>
    </section>
    ...
    <section id="gallery" class="gallery-section">
        <h2>Prototype Installation</h2>
        <p style="text-align: center; color: #666; margin-bottom: 30px;">See the kit installed on Travis's personal Jimny. This is the real deal.</p>
        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="657388042_1639675567073408_8093226719779578230_n.jpg" alt="Supercharger installation view">
                <div class="gallery-caption">
                    <p>Bracket & Mounting</p>
                </div>
            </div>
            <div class="gallery-item">
                <img src="661679050_1669379540747797_7481478028683903763_n.jpg" alt="Supercharger belt system">
                <div class="gallery-caption">
                    <p>Belt & Pulley System</p>
                </div>
            </div>
            <div class="gallery-item">
                <img src="658341335_2040094013387734_8984838484918978115_n.jpg" alt="Complete installation">
                <div class="gallery-caption">
                    <p>Final Assembly</p>
                </div>
            </div>
    ...
    <section id="faq" class="faq-section">
        ...
        <div class="faq-grid">
            ...
            <div class="faq-item">
                ...
                <p>Yes! Check out the prototype photos and video above. This is the real-world installation you'll be getting.</p>
            </div>
...
def save_website(html_content, output_dir='.tmp/website'):
    ...
    print(f"✓ Product website updated: {html_file}")
    return output_path


def main():
    print("\n" + "="*60)
    print("Product Sales Website Generator (with Media)")
    print("Jimny M65 Supercharger Kit")
    print("="*60 + "\n")

    print("🔨 Generating product website with photos & video...")
    html = generate_product_html()

    output_dir = save_website(html)

    print(f"\n✓ Website ready with media!")
    print(f"📁 Location: {output_dir.absolute()}/index.html")
    print(f"\n📖 View with all assets:")
    print(f"   - Video intro from Travis")
    print(f"   - 3 prototype installation photos")
    print(f"   - Full product specs & pricing")
    print(f"   - Contact links & FAQ")
    print(f"\n✨ Sections included:")
    print("   ✓ Hero with video CTA")
    print("   ✓ Video section (auto-plays controls)")
    print("   ✓ Photo gallery (3 images)")
    print("   ✓ Features grid")
    print("   ✓ BOM & specifications")
